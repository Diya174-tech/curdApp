                    ...
                    <form action="{{ url('fees-masters') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="parent_fees" class="form-control" placeholder="Enter Parent Fees value" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="CCFRI" class="form-label">CCFRI <span class="text-danger">*</span></label>
                                <input type="number" name="CCFRI" class="form-control" placeholder="Enter CCFRI value" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="fees_amount" class="form-label">Fees Amount <span class="text-danger">*</span></label>
                                <input type="number" name="fees_amount" class="form-control" placeholder="Enter total fees amount" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="number_of_days" class="form-label">Number of days <span class="text-danger">*</span></label>
                                <input type="number" name="number_of_days" class="form-control" placeholder="Enter Number of days" required>
                            </div>
